...
from morphata.spec import FiniteAcceptance, Guard, SizedAutomaton
...
class NFA[In](SizedAutomaton[AbstractSet[In], bool, NFAState, int]):
    ...
    @property
    def acceptance_condition(self) -> FiniteAcceptance[int]:
        """Acceptance condition based on final locations."""
        return FiniteAcceptance(self.final_locations)
