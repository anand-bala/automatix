...
def smooth_maximum(x: _ArrayLike, y: _ArrayLike, temperature: float = 1.0) -> _Array:
...
def smooth_max(x: _ArrayLike, axis: _Axis = None, temperature: float = 1.0) -> _Array:
...
def smooth_minimum(x: _ArrayLike, y: _ArrayLike, temperature: float = 1.0) -> _Array:
...
def smooth_min(x: _ArrayLike, axis: _Axis = None, temperature: float = 1.0) -> _Array:
...
@functools.partial(jax.custom_vjp, nondiff_argnums=(1,))
def soft_boolean_sum(x: _ArrayLike, axis: _Axis = None) -> _Array:
...
def _soft_boolean_sum_fwd(x: _ArrayLike, axis: _Axis) -> tuple[_Array, tuple[_Array, _Axis]]:
...
def _soft_boolean_sum_bwd(axis: _Axis, res: tuple[_ArrayLike, _Axis], g: _ArrayLike) -> tuple[_Array]:
...
def smooth_boolean_sum(x: _ArrayLike, axis: _Axis = None, temperature: float = 1.0) -> _Array:
...
def _smooth_boolean_sum_bwd(
    axis: _Axis,
    temperature: float,
    res: tuple[_ArrayLike, _Axis, float],
    g: _ArrayLike,
) -> tuple[_Array]:
